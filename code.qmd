...
working_dir <- here("data")

xls_path <- local_tempfile(fileext = ".xlsx")

#edu <- read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-01-23/english_education.csv')
...
english_education <- read_xlsx(xls_path, sheet = "Data", na = "*") |> 
  clean_names()

write_csv(
  english_education,
  path(working_dir, "english_education.csv"))
```
